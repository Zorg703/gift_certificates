...
/**
 * The Gift certificate dto converter.
 * Convert GiftCertificate in to GiftCertificateDTO and List<GiftCertificate>
 * to  List<GiftCertificateDTO> there and back again
 *
 *  */
