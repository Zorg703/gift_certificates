...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private static final String INCORRECT_INPUT_PARAMS = "input_param";
    private static final String INCORRECT_PRICE = "message.price";
    ...
    public ResponseEntity<ErrorResponse> handleControllerException(ControllerException e, WebRequest request) {
        ErrorResponse errorResponse = getErrorResponse(e, request, INCORRECT_INPUT_PARAMS);
        return new ResponseEntity<>(errorResponse, HttpStatus.NOT_FOUND);
    }
    ...
    public ResponseEntity<ErrorResponse> handleServiceException(ServiceException e, WebRequest request) {
        ErrorResponse errorResponse = getErrorResponse(e, request, INCORRECT_PRICE);
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ErrorResponse errorResponse= getErrorResponse(ex, request, INCORRECT_INPUT_PARAMS);
        return new ResponseEntity<>(errorResponse, HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<ErrorResponse> handleOptimisticException(OptimisticLockException e, WebRequest request) {
        ErrorResponse errorResponse = getErrorResponse(e, request, INCORRECT_PRICE);
        return new ResponseEntity<>(errorResponse, HttpStatus.UPGRADE_REQUIRED);
    }

    @ExceptionHandler(value = ObjectOptimisticLockingFailureException.class)
    public ResponseEntity<ErrorResponse> handleOptimisticException(ObjectOptimisticLockingFailureException e, WebRequest request) {
        ErrorResponse errorResponse = getErrorResponse(e, request, INCORRECT_PRICE);
        return new ResponseEntity<>(errorResponse, HttpStatus.UPGRADE_REQUIRED);
    }
    /**
